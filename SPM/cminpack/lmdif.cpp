...
void lmdif(void f(int,int,double*,double*,int *, double *),int m,
...
/* calculate jacobian matrix */
        iflag = 2;
        fdjac2(f,m,n,x,fvec,fjac,&iflag,epsfcn,wa4,params);
        *nfev += n;
        if (iflag < 0) {
            *info = iflag;
            return;
