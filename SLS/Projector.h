...
public:
    ...
    {
        std::cout << (size_t )(std::ceil(std::log2((float)width_)) + std::ceil(std::log2((float)height_))) << std::endl;
        return (size_t )(std::ceil(std::log2((float)width_)) + std::ceil(std::log2((float)height_)));
    }
};
}
